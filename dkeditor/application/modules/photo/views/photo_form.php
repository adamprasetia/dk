<ul class="nav nav-tabs">
	...
	<li role="presentation" class="active"><?php echo anchor('photo/upload','Unggah Foto') ?></li>
</ul>
<h1 class="page-header">Unggah Foto</h1>
	...
	<div class="panel-body">
		...
		<?php if (isset($row->filename)): ?>
			<div class="form-group form-inline">
				...
				<img width="100px" src="<?php echo config_item('assets').'photo/'.$row->filename ?>">
			</div>			
		<?php endif ?>
	</div>
	<div class="panel-footer">
		<button class="btn btn-success btn-sm" type="submit" onclick="return confirm('Anda yakin')"><span class="glyphicon glyphicon-upload"></span> Unggah</button>
